...
public final class UploadForm {
    ...
    public Fichier enregistrerFichier(HttpServletRequest request, String chemin) {
        ...
        // Récupération du contenu du champ fichier du formulaire. Il faut ici utiliser la méthode getPart(), comme
    ...
    //------------------------------------------------------------------------------------------------------------------
    //Méthode utilitaire qui a pour but d'écrire le fichier passé en paramètre sur le disque, dans le répertoire donné
    // et avec le nom donné.
    //------------------------------------------------------------------------------------------------------------------
